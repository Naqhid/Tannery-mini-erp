...
router.get('/by-product/:productId', ctrl.listByProduct);
router.get('/latest-by-product/:productId', ctrl.getLatestByProduct);
router.post('/import', requireWriteAccess, ctrl.importBom);
