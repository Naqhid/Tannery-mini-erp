-- ============================================================
-- Migration 008: Seed Data for New Modules (Final Version)
-- Description: Sample seed data for new modules with correct status values
-- ============================================================
...
-- Insert sample supplier pricing records (using only 'Approved' or 'Pending' status)
...
(1, 5, 'LTR', 62.00, '2024-04-16', '2024-04-30', 'Pending', 1, NOW()),
