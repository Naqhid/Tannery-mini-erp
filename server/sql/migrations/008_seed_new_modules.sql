-- ============================================================
-- Migration 008: Seed Data for New Modules
-- Description: Sample seed data for Batch/Lot Tracking, Supplier Pricing,
--              Price Approval, and Physical Stock Entry modules
-- ============================================================
...
VALUES 
('BTCH-202405-0012', 1, 1, 'SO-2024-0015', 'LTH-1001', 'Cow Leather', '2024-05-20', 'Tanning', 'Tanning', 2450.00, 2320.00, 94.69, 'Completed', 'Batch for Leather World Co.', 1, NOW()),
('BTCH-202405-0013', 1, 1, 'SO-2024-0018', 'LTH-1002', 'Buffalo Leather', '2024-05-20', 'Tanning', 'Tanning', 800.00, 760.00, 95.00, 'Completed', 'Batch for Global Leathers Ltd.', 1, NOW()),
('BTCH-202405-0014', 2, 2, 'SO-2024-0021', 'LTH-1003', 'Sheep Leather', '2024-05-21', 'Finishing', 'Finishing', 400.00, 380.00, 95.00, 'In-Process', 'Batch for Premium Shoes Pvt. Ltd.', 1, NOW()),
('BTCH-202405-0015', 2, 2, 'SO-2024-0023', 'LTH-1004', 'Goat Leather', '2024-05-21', 'Dyeing', 'Dyeing', 350.00, 330.00, 94.29, 'In-Process', 'Batch for Fashion Footwear Inc.', 1, NOW()),
('BTCH-202405-0016', 3, 3, 'SO-2024-0025', 'LTH-1005', 'Cow Leather', '2024-05-22', 'Tanning', 'Tanning', 300.00, 280.00, 93.33, 'In-Process', 'Batch for Elite Exports', 1, NOW());
...
-- Insert sample supplier pricing records
INSERT INTO supplier_pricing (supplier_id, material_id, item_group, supplier_part_no, uom, unit_price, currency, min_order_qty, price_type, valid_from, valid_to, status, remarks, approved_by, approved_date, approval_notes, last_approved_price, last_approved_date, created_by, created_at) 
VALUES 
(1, 1, 'Chemicals', 'CP-1001', 'KG', 200.00, 'INR', 100.00, 'Purchase Price', '2024-05-01', '2024-05-30', 'Approved', 'Price revision', 1, '2024-05-15', 'Monthly revision', 200.00, '2024-05-15', 1, NOW()),
(1, 1, 'Chemicals', 'CP-1001', 'KG', 210.00, 'INR', 100.00, 'Purchase Price', '2024-04-01', '2024-04-30', 'Approved', 'Previous month price', 1, '2024-04-15', 'Monthly revision', 210.00, '2024-04-15', 1, NOW()),
(1, 1, 'Chemicals', 'CP-1001', 'KG', 220.00, 'INR', 100.00, 'Purchase Price', '2024-03-01', '2024-03-31', 'Approved', 'Old price', 1, '2024-03-15', 'Price revision', 220.00, '2024-03-15', 1, NOW()),
(1, 2, 'Chemicals', 'ST-2001', 'KG', 185.00, 'INR', 50.00, 'Purchase Price', '2024-05-01', '2024-05-31', 'Approved', 'Sodium Sulphide', 1, '2024-05-10', 'Quarterly revision', 185.00, '2024-05-10', 1, NOW()),
(1, 3, 'Chemicals', 'FA-3001', 'LTR', 65.00, 'INR', 10.00, 'Purchase Price', '2024-05-01', '2024-05-31', 'Approved', 'Formic Acid 85%', 1, '2024-05-05', 'Quarterly revision', 65.00, '2024-05-05', 1, NOW()),
(1, 4, 'Chemicals', 'FL-4001', 'KG', 145.00, 'INR', 25.00, 'Purchase Price', '2024-05-01', '2024-05-31', 'Approved', 'Fatliquor FL 100', 1, '2024-05-08', 'Old contract', 145.00, '2024-05-08', 1, NOW()),
(1, 5, 'Chemicals', 'FA-3002', 'LTR', 62.00, 'INR', 15.00, 'Purchase Price', '2024-04-16', '2024-04-30', 'Expired', 'Formic Acid 85% - Old', 1, '2024-04-15', 'New contract', 62.00, '2024-04-15', 1, NOW()),
(1, 6, 'Chemicals', 'FL-4002', 'KG', 130.00, 'INR', 20.00, 'Purchase Price', '2024-05-01', '2024-05-31', 'Pending', 'Price reduced', NULL, NULL, 'Pending approval', 145.00, '2024-04-01', 1, NOW());
...
VALUES 
(1, 1, 1, 220.00, 210.00, -4.55, 'Decrease', 'Monthly revision', '2024-04-01', '2024-04-30', 1, NOW()),
(1, 1, 1, 210.00, 200.00, -4.76, 'Decrease', 'Monthly revision', '2024-05-01', '2024-05-30', 1, NOW()),
(2, 2, 1, 180.00, 185.00, 2.78, 'Increase', 'Quarterly revision', '2024-05-01', '2024-05-31', 1, NOW()),
(6, 6, 1, 145.00, 130.00, -10.34, 'Decrease', 'Price reduced', '2024-05-01', '2024-05-31', 1, NOW());
...
-- Insert sample physical stock entries
...
VALUES 
('PSE-2024-00045', '2024-05-20', '2024-05-20', 1, 'All', 'Main Store', NULL, NULL, NULL, 'All', NULL, 'All', 'Ref / Document No.', 6, 2, 4, -7.00, -1320.00, 'Completed', 'Enter remarks (optional)...', 1, NOW());
...
VALUES 
('PB-202405-0001', 1, 1, 1, 'SO-2024-0015', 'LTH-1001', 'Cow Leather', 'Black', 'Full Chrome', '2024-05-20', 1, 'Tanning', 2500.00, 2500.00, 2450.00, 0.00, 2320.00, 130.00, 92.80, 'In-Process', 'Batch in tanning stage', 1, NOW());